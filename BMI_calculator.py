...
title_label = tkinter.Label(root, font=font1, text='BMI CALCULATOR', fg="white", bg="black")
title_label.place(x=20, y=20)
height_label = tkinter.Label(root, font=font2, text='Height (m)', fg="white", bg="black")
height_label.place(x=20, y=100)
weight_label = tkinter.Label(root, font=font2, text='Weight (kg)', fg="white", bg="black")
weight_label.place(x=20, y=160)
result_label = tkinter.Label(root, font=font2, fg="white", bg="black", text="")
result_label.place(x=20, y=260)
category_label = tkinter.Label(root, font=font2, fg="white", bg="black", text="")
